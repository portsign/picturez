...
class QuotesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'quotes_pic' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'quotes_ibfk_1' => ['type' => 'foreign', 'columns' => ['users_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'id' => 1,
            'users_id' => 1,
            'quotes_pic' => 'Lorem ipsum dolor sit amet',
            'created' => '2016-03-08 19:33:07'
        ],
    ];
}
